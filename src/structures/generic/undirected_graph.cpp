...
namespace vroom
{
    namespace utils
    {
        ...
        template <class T>
        UndirectedGraph<T>::UndirectedGraph(std::vector<Edge<T>> edges) : _edges{std::move(edges)}
        {
        ...
        template <class T>
        std::size_t UndirectedGraph<T>::size() const
        {
            return _size;
        }

        template <class T>
        std::vector<Edge<T>> UndirectedGraph<T>::get_edges() const
        {
            return _edges;
        }

        template <class T>
        std::unordered_map<Index, std::list<Index>> UndirectedGraph<T>::get_adjacency_list() const
        {
