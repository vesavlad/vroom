...
namespace vroom
{
    class RawRoute
    {
     public:
        ...
        bool is_valid_addition_for_tw(const Input&, const Index, const Index) const { return true; };
        ...
        bool is_valid_removal(const Input&, const Index, const unsigned) const { return true; };
