...
namespace vroom
{
    namespace cvrp
    {
        ...
        bool IntraCrossExchange::is_valid() { return true; }
        ...
        std::vector<Index> IntraCrossExchange::addition_candidates() const { return {}; }

        std::vector<Index> IntraCrossExchange::update_candidates() const { return {s_vehicle}; }
