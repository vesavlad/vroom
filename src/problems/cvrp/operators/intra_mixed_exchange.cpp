...
namespace vroom
{
    namespace cvrp
    {
        IntraMixedExchange::IntraMixedExchange(const Input&                input,
                                               ...
                                               Index                       s_rank,
                                               Index                       t_rank)
            : Operator(input, sol_state, s_route, s_vehicle, s_rank, s_route, s_vehicle, t_rank), reverse_t_edge(false)
        {
        ...
        bool IntraMixedExchange::is_valid() { return true; }
        ...
        std::vector<Index> IntraMixedExchange::addition_candidates() const { return {}; }

        std::vector<Index> IntraMixedExchange::update_candidates() const { return {s_vehicle}; }
