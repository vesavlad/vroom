...
namespace vroom
{
    class VRPTW : public VRP
    {
     private:
        ...
        static constexpr std::array<HeuristicParameters, 32> heterogeneous_parameters =
     ...
     public:
        ...
        virtual Solution solve(unsigned exploration_level, unsigned nb_threads) const override;
    };
