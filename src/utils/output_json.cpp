    ...
    namespace io
    {
        rapidjson::Document to_json(const Solution& sol, bool geometry)
        {
            ...
            if (sol.code != 0) {
                ...
                json_output.AddMember("summary", to_json(sol.summary, geometry, allocator), allocator);
                ...
                for (const auto& job : sol.unassigned) {
                    ...
                    if (job.location.has_coordinates()) {
                        json_job.AddMember("location", to_json(job.location, allocator), allocator);
                    }
        ...
        rapidjson::Value to_json(const Summary& summary, bool geometry, rapidjson::Document::AllocatorType& allocator)
        {
            ...
            json_summary.AddMember("computing_times", to_json(summary.computing_times, geometry, allocator), allocator);

            return json_summary;
        }

        rapidjson::Value to_json(const Route& route, bool geometry, rapidjson::Document::AllocatorType& allocator)
        {
        ...
        rapidjson::Value to_json(const ComputingTimes& ct, bool geometry, rapidjson::Document::AllocatorType& allocator)
        {
        ...
        rapidjson::Value to_json(const Step& s, bool geometry, rapidjson::Document::AllocatorType& allocator)
        {
        ...
        rapidjson::Value to_json(const Location& loc, rapidjson::Document::AllocatorType& allocator)
        {
        ...
        void write_to_json(const Solution& sol, bool geometry, const std::string& output_file)
        {
